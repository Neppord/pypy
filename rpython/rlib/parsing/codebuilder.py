...
class Codebuilder(object):
    ...
    def make_parser(self):  # type: () -> object
    ...
    def block(self, blockstarter):  # type: (str) -> None
    ...
    def end_block(self, starterpart=""):  # type: (str) -> None
    ...
    def store_code_away(self):  # type: () -> tuple[list, list]
    ...
    def restore_code(self, (blocks, code)):  # type: (tuple[list, list]) -> tuple[list, list]
